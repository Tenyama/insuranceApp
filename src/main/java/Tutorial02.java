        ...
        */
        ...
        try {
            ...
            terminal.addResizeListener((terminal1, newSize) -> {
                ...
                textGraphics.drawLine(new TerminalPosition(0, 0), new TerminalPosition(newSize.getColumns() - 1, 0), '─');
                textGraphics.drawLine(new TerminalPosition(0, 0), new TerminalPosition(0, newSize.getRows() - 1), '│');
                textGraphics.drawLine(new TerminalPosition(newSize.getColumns() - 1, newSize.getRows() - 1), new TerminalPosition(0, newSize.getRows() - 1), '─');
                textGraphics.drawLine(new TerminalPosition(newSize.getColumns() - 1, newSize.getRows() - 1), new TerminalPosition(newSize.getColumns() - 1, 0), '│');
                textGraphics.putString(0, 0, "┌");
                textGraphics.putString(newSize.getColumns() - 1, 0, "┐");
                textGraphics.putString(0, newSize.getRows() - 1, "└");
                textGraphics.putString(newSize.getColumns() - 1, newSize.getRows() - 1, "┘");
                textGraphics.putString(5, 3, "Terminal Size: ", SGR.BOLD);
